...
const Picture = () => {
  return(
    <View>
       <Image source={{ uri: 'https://th.bing.com/th/id/R.c04eb3ced75616cb0f2a2c583566b974?rik=MgTBaDqKDoA8Dw&riu=http%3a%2f%2ffxmedcenters.com%2fwp-content%2fuploads%2f2015%2f07%2ftired-lady.jpg&ehk=W5aGhUpNm17sSLHDTttiWTLldQYy0SFTHot77iCDrcA%3d&risl=&pid=ImgRaw&r=0' }} style ={styles.Picture} />
     </View>
  ) 
};
const BioData = () =>{
  return(
    <View> 
<Text style ={styles.name}> Riza Dogoy Batulanon </Text>
